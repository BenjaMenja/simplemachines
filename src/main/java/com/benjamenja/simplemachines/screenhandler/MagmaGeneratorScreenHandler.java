...
public class MagmaGeneratorScreenHandler extends ScreenHandler {

    private final MagmaGeneratorBlockEntity blockEntity;
    private final ScreenHandlerContext context;

    // Client Constructor
    public MagmaGeneratorScreenHandler(int syncId, PlayerInventory playerInventory, BlockPosPayload payload) {
        this(syncId, playerInventory, (MagmaGeneratorBlockEntity) playerInventory.player.getWorld().getBlockEntity(payload.pos()));
    }

    // Server (Main) Constructor
    public MagmaGeneratorScreenHandler(int syncId, PlayerInventory playerInventory, MagmaGeneratorBlockEntity magmaGeneratorBlockEntity) {
        super(ModScreenHandlerTypes.MAGMA_GENERATOR, syncId);
        this.blockEntity = magmaGeneratorBlockEntity;
    ...
    public boolean canUse(PlayerEntity player) {
        return canUse(this.context, player, ModBlocks.MAGMA_GENERATOR);
    }

    public MagmaGeneratorBlockEntity getBlockEntity() {
