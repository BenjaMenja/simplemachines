...
public class MagmaGeneratorScreen extends HandledScreen<MagmaGeneratorScreenHandler> {

    private static final Identifier TEXTURE = SimpleMachines.id("textures/gui/container/magma_generator.png");

    public MagmaGeneratorScreen(MagmaGeneratorScreenHandler handler, PlayerInventory inventory, Text title) {
